...
wk_cufftw: cufftw_WK_3D_imaging_experiment.cpp
	nvcc cufftw_WK_3D_imaging_experiment.cpp -o $@ -O2 -DARMA_DONT_USE_WRAPPER -DARMA_USE_BLAS -DARMA_USE_LAPACK -DARMA_USE_HDF5 -lblas -llapack -larmadillo -lhdf5 -lcufft -lcufftw -lm $(CUDA_INC_PATH) $(CUDA_LIB_PATH) $(HDF5_INC_PATH) $(HDF5_LIB_PATH)
