...
wk_fftw: fftw_WK_3D_imaging_experiment.cpp
	g++ fftw_WK_3D_imaging_experiment.cpp -o $@ -O2 -fopenmp -DARMA_DONT_USE_WRAPPER -DARMA_USE_BLAS -DARMA_USE_LAPACK -DARMA_USE_HDF5 -lblas -llapack -larmadillo -lhdf5 -lfftw3 -lm $(HDF5_INC_PATH) $(HDF5_LIB_PATH)

wk_cufftw: cufftw_WK_3D_imaging_experiment.cpp
	nvcc cufftw_WK_3D_imaging_experiment.cpp -o $@ -O2 -Xcompiler -fopenmp -DARMA_DONT_USE_WRAPPER -DARMA_USE_BLAS -DARMA_USE_LAPACK -DARMA_USE_HDF5 -lblas -llapack -larmadillo -lhdf5 -lcufft -lcufftw -lm $(CUDA_INC_PATH) $(CUDA_LIB_PATH) $(HDF5_INC_PATH) $(HDF5_LIB_PATH)

bp: BP_3D_imaging.cpp
	g++ BP_3D_imaging.cpp -o $@ -O2 -fopenmp -DARMA_DONT_USE_WRAPPER -DARMA_USE_BLAS -DARMA_USE_LAPACK -DARMA_USE_HDF5 -lblas -llapack -larmadillo -lhdf5 $(HDF5_INC_PATH) $(HDF5_LIB_PATH)

bp_cuda: program

program: bp_kernel.o
	g++ cuda_BP_3D_imaging.cpp bp_kernel.o -o $@ -O2 -DARMA_DONT_USE_WRAPPER -DARMA_USE_BLAS -DARMA_USE_LAPACK -DARMA_USE_HDF5 -lblas -llapack -larmadillo -lhdf5 -lm -lcuda -lcudart $(CUDA_INC_PATH) $(CUDA_LIB_PATH) $(HDF5_INC_PATH) $(HDF5_LIB_PATH)
